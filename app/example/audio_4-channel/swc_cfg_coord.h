...
#define NODE3_ADDRESS       0x03
#define NODE4_ADDRESS       0x04

#define LOCAL_ADDRESS       COORDINATOR_ADDRESS
#define REMOTE_ADDRESS_1    NODE1_ADDRESS
#define REMOTE_ADDRESS_2    NODE2_ADDRESS
#define REMOTE_ADDRESS_3    NODE3_ADDRESS
#define REMOTE_ADDRESS_4    NODE4_ADDRESS
...
#define TX_TO_NODE1_TIMESLOTS { \
    MAIN_TIMESLOT(0) \
}
#define TX_TO_NODE2_TIMESLOTS { \
    MAIN_TIMESLOT(1) \
}
#define TX_TO_NODE3_TIMESLOTS { \
    MAIN_TIMESLOT(2) \
}
#define TX_TO_NODE4_TIMESLOTS { \
    MAIN_TIMESLOT(3) \
}
