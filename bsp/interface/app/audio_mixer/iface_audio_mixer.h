 ...
 */
#ifndef IFACE_AUDIO_MIXER_H_
#define IFACE_AUDIO_MIXER_H_
...
/** @brief Notify user of the Node1 wireless RX connection status.
 */
void iface_node1_rx_conn_status(void);

/** @brief Notify user of the Node2 wireless RX connection status.
 */
void iface_node2_rx_conn_status(void);
