/** @file  iface_audio_streaming.h
 *  @brief This file contains the prototypes of functions configuring the
 *         audio streaming application which calls the underlying BSP functions.
 *
 ...
 */
#ifndef IFACE_AUDIO_STREAMING_H_
#define IFACE_AUDIO_STREAMING_H_
...
#endif /* IFACE_AUDIO_STREAMING_H_ */
