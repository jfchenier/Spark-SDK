/** @file  iface_audio_user_data.h
 *  @brief This file contains the prototypes of functions configuring the
 *         audio user data application which calls the underlying BSP functions.
 *
 ...
 */
#ifndef IFACE_AUDIO_USER_DATA_H_
#define IFACE_AUDIO_USER_DATA_H_
...
/** @brief Mirror the payload's value on the device's LED.
 */
void iface_payload_received_status(uint8_t data);
...
#endif /* IFACE_AUDIO_USER_DATA_H_ */
