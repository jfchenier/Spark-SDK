...
/* PUBLIC FUNCTIONS ***********************************************************/
void sac_packing_init(void *instance, sac_pipeline_t *pipeline, mem_pool_t *mem_pool, sac_error_t *err)
{
    (void)pipeline;
    (void)mem_pool;
...
uint32_t sac_packing_ctrl(void *instance, sac_pipeline_t *pipeline, uint8_t cmd, uint32_t arg, sac_error_t *err)
{
    (void)pipeline;
    (void)arg;
...
uint16_t sac_packing_process(void *instance, sac_pipeline_t *pipeline, sac_header_t *header, uint8_t *data_in, uint16_t size,
